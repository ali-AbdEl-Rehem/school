...
/// <summary>Filter / sort / paging options for the student list.</summary>
public class StudentQuery
{
    ...
    /// <summary>One of: name, studentNumber, department, gpa, enrollmentDate. Defaults to name.</summary>
